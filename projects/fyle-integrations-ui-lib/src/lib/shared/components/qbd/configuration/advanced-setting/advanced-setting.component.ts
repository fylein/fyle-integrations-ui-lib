...
import { ClickEvent, Page, QBDConfigurationCtaText, QBDOnboardingState, QBDProgressPhase, QBDScheduleFrequency, ToastSeverity, UpdateEvent } from '../../../../../core/models/enum/enum.model';
import { AdvancedSettingModel, QBDAdvancedSettingsGet, QBDEmailOption } from '../../../../../core/models/qbd/qbd-configuration/advanced-setting.model';
...
import { QbdAdvancedSettingService } from '../../../../../core/services/qbd/qbd-configuration/qbd-advanced-setting.service';
...
@Component({
  selector: 'fyle-integrations-ui-lib-app-advanced-setting',
