...
import { QBDOnboardingState } from '../../../../../core/models/enum/enum.model';
import { QBDOnboardingStepper } from '../../../../../core/models/qbd/misc/qbd-onboarding-stepper.model';
import { QbdWorkspaceService } from '../../../../../core/services/qbd/qbd-core/qbd-workspace.service';

@Component({
  selector: 'fyle-integrations-ui-lib-app-onboarding-stepper',
